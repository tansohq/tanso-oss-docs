...
<Frame caption="Credits → Weights: the live tariff, with a cutover scheduled ahead of it">
  <img src="/images/console/weights.png" alt="Credit weights table with a scheduled tariff change queued above it" />
</Frame>
