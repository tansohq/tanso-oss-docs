...
requests and will not — that was decided before the build side was started.
...
This is the join the two halves of the engine exist for. The build side knows
what a project cost in AI spend; the serve side knows what a feature earns
...
1. **Spend → Teams**, open (or create) a *project* unit and pick the feature
   it shipped under **Feature** — the same features the serve side prices in
   plans.
