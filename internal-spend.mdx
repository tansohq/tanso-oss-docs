...
OpenAI admin key, a Cursor admin API key (Enterprise plan), or a GitHub token
with the *View Organization Copilot Metrics* permission plus the org name. The key is encrypted at rest under `APP_SECRETS_KEY` and
